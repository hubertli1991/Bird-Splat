...
var Game = function() {
  ...
  this.verticalGapMinimum = 80;
  this.horizontalGapMinimum = 50;
  this.minimumGapBetweenAsteroids = 80;
...
// Game.prototype.verticalGapValidation = function(asteroidOne, asteroidTwo) {
//   return Util.verticalDistance( asteroidOne.pos, asteroidTwo.pos ) > asteroidOne.radius + asteroidTwo.radius + this.verticalGapMinimum;
//
// };
//
// Game.prototype.horizontalGapValidation = function(asteroidOne, asteroidTwo) {
//
// };
