...
/***/ function(module, exports, __webpack_require__) {
	...
	Game.prototype.addAsteroid = function() {
	  ...
	  if ( this.collideCheck(asteroid, this.asteroids[numOfAsteroids - 1], 125) || ( numOfAsteroids >= 2 && Math.abs(asteroid.pos[1]-this.asteroids[numOfAsteroids - 2].pos[1]) > 200 ) ) {
	    // if ( numOfAsteroids >= 2 && Util.dist( asteroid.pos, this.asteroids[numOfAsteroids - 2].pos) > 5 ) {
	    //   debugger;
	    // }
	    this.addAsteroid();
	  } else {
