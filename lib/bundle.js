...
/***/ function(module, exports, __webpack_require__) {
	...
	Game.prototype.birdOutOfBounds = function(bird) {
	  if ( this.bird[0] === undefined || this.bird[0].pos[1] < 0 || this.bird[0].pos[1] > 600 ) {
	    this.shouldGameContinue = false;
	  }
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	MovingObject.prototype.increment = function() {
	  this.birdImageIndex = (this.birdImageIndex + 1)%5;
	};
	...
	MovingObject.prototype.draw = function(ctx) {
	  ...
	  if ( this.flyingAnimationOn ) {
	      this.counter += 1;
	      // setTimeout( function() {this.counter += 1;}.bind(this), 1000/15);
	      if (this.counter === 2) {
	        this.birdImageIndex += 1;
	        this.counter = 0;
	      }
	      if ( this.birdImageIndex > 4 ) {
	        // this.birdImageIndex = 0;
	        // debugger
	  ...
	  if ( this.obj === "asteroid" ) {
	    this.sprite.render(this.spriteImg, this.pos[0]-this.radius*1.1, this.pos[1]-this.radius*1.1);
	  }
	};
